...
debug_local(debug,"AdMob:", json_encode(async_load));
...
switch(async_load[?"type"])
{
	...
	case "AdMob_OnInitialized":
		...
		//
		debug_log("AdMob", "RequestInfoUpdate",debug_var(AdMob_Consent_Mode_PRODUCTION,AdMob_Consent_Mode_DEBUG_GEOGRAPHY_DISABLED));
		AdMob_Consent_RequestInfoUpdate(debug_var(AdMob_Consent_Mode_PRODUCTION,AdMob_Consent_Mode_DEBUG_GEOGRAPHY_DISABLED));
		break;
	...
	case "AdMob_RewardedVideo_OnReward":
		...
		debug_local(debug,"User Earned Reward");
		break;
